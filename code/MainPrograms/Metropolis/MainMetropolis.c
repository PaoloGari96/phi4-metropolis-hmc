...
int main(int argc, char* argv[])
{
   ...
   {
      metropolis(&act_params,&metro_params);
   }

   for(i=0;i<metro_params.nsweep/metro_params.naccu;i++)
   {
      m=0.;
      sm=0.;
      qm=0.;
      ...
      printf("%d %e %e %e \n",i+1,m/(metro_params.naccu),sm/(metro_params.naccu),qm/(metro_params.naccu));
   }
